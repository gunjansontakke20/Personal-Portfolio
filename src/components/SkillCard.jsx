...
const SkillCard = ({Skill, percentage, color, move}) => {
  return <div className="border border-[rgba(255,255,255,0.3)] rounded-md px-5 py-1 cursor-pointer group w-full flex items-center justify-between relative gap-2" style={{
    boxShadow:"inset 0 0 10px rgbs(255,255,255,0.3)",
  ...
  {/* percentage */}
  <div className="w-16 h-10 rounded-md relative overflow-hidden flex items-center justify-center" style={{border: `1px solid ${color}`}}>
    <motion.div 
     initial = {{height : 0}}
