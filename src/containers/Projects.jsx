  ...
  return (
    ...
    <div className="w-full flex items-center justify-center py-24 ">
     ...
     className="flex items-center justify-around w-52">
      ...
      <p className="text-transparent bg-clip-text bg-gradient-to-r from from-primary to-secondary font-bold" >Project</p>
...
const ProjectCard = ({project}) => {
  ...
  return (
      <motion.div key={project.id} className="overflow-hidden cursor-pointer relative rounded-md" onMouseEnter={ () => setIsHoverred(true)} 
